                        ...
                        <ContentCollection>
                            <dx:ContentControl>
                                <div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>" SelectCommand="select *, e2.EmployeeID  from tblEmployee e1 left join tblEmpManagerLevel e2 on e1.EmployeeID = e2.EmployeeID where e2.EmployeeID is null"></asp:SqlDataSource>
                                </div>
                        ...
                        <ContentCollection>
                            <dx:ContentControl>
                                <div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
                                    ...
                                    <asp:SqlDataSource ID="DSEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>" SelectCommand="SELECT [EmployeeID], [EmployeeName], [SectionName], [LineName], [PosName] FROM [tblEmployee] ORDER BY [SectionName], [LineName]"></asp:SqlDataSource>
                                </div>
                            </dx:ContentControl>
                        </ContentCollection>
                    </dx:TabPage>
