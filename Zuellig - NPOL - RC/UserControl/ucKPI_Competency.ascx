<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_Competency.ascx.cs" Inherits="NPOL.UserControl.ucKPI_Competency" %>
    ...
    <table style="width: 100%;">
        ...
        <div style="margin-top: 10px">
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                SelectMethod="GetAllStore_Competency" TypeName="NPOL.App_Code.Business.Store_CompetencyService"></asp:ObjectDataSource>
        </div>
    </ContentTemplate>
</asp:UpdatePanel>