<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_EmpCompetency.ascx.cs" Inherits="NPOL.UserControl.ucKPI_EmpCompetency" %>
    ...
    function OnBatchEditEndEditing(s, e) {
        window.setTimeout(function () {
            ...
            if (Score < 0 || Score > 5) {
                ...
                s.batchEditApi.SetCellValue(e.visibleIndex, "Score", "", null, true);
            }
            else
                    ...
                    <DetailRow>
                        <dx:ASPxGridView ID="detailGrid" runat="server" Width="100%" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Name="Score" Caption="<%$ Resources:KPI_Competency,colRating %>" FieldName="Score"
                                    Width="10%" MinWidth="120" ShowInCustomizationForm="true" VisibleIndex="4"
                                    EditCellStyle-HorizontalAlign="Center" EditCellStyle-VerticalAlign="Middle"
