<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPIReview_EmpCompetency.ascx.cs" Inherits="NPOL.UserControl.ucKPIReview_EmpCompetency" %>
            ...
            window.setTimeout(function () {
                ...
                if (adj_Score == null)
                {
                    if (adj_Important > 0)
                        ...
                        point = Important * Score * 1.0;
                    s.batchEditApi.SetCellValue(e.visibleIndex, "Point", point, null, true);
                }
                else {
                    if (adj_Score < 0 || adj_Score > 5) {
                        if (s.cpLang == "en")
                            alert('* Rating must be in range from 0 to 5.')
                        else
                            alert('* Điểm đánh giá phải nằm trong khoản từ 0 đến 5')
                        s.batchEditApi.SetCellValue(e.visibleIndex, "Adj_Score", "", null, true);
                    }
                    else {
    ...
    <ContentTemplate>
        ...
        <div style="margin-top: 10px;">
            ...
            <dx:ASPxGridView ID="grid" runat="server" EnableTheming="True" Theme="Office2010Black" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataTextColumn Caption="Order" FieldName="Order" Width="50px" ShowInCustomizationForm="True" VisibleIndex="1">
                                ...
                                <dx:GridViewBandColumn Caption="<%$ Resources:KPI_Competency,colRating %>" VisibleIndex="4">
                                    <Columns>
                                        <dx:GridViewDataTextColumn Width="5%" MinWidth="100" ShowInCustomizationForm="True" VisibleIndex="4"
                                            FieldName="Score" ReadOnly="true" Caption="<%$ Resources:KPI_Competency,colOldValue %>" >
                                            <%--<EditFormSettings Visible="False" />--%>
                                            <CellStyle BackColor="Info" HorizontalAlign="Center" Font-Bold="false"></CellStyle>
                                            <PropertiesTextEdit DisplayFormatString="0.##" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn Width="5%" MinWidth="100" FieldName="Adj_Score" VisibleIndex="5"
                                            ShowInCustomizationForm="True" Caption="<%$ Resources:KPI_Competency,colNewValue %>" 
                                            PropertiesTextEdit-ClientSideEvents-KeyPress="OnKeyPress">
                                            <CellStyle HorizontalAlign="Center" Font-Bold="true" ForeColor="Red"></CellStyle>
                                            <PropertiesTextEdit DisplayFormatString="0.##" MaxLength="4"/>
                                        </dx:GridViewDataTextColumn>
                                    </Columns>
                                ...
                                <dx:GridViewBandColumn Caption="<%$ Resources:KPI_Competency,colImportant %>" VisibleIndex="6">
                                    <Columns>
                                        <dx:GridViewDataTextColumn Width="5%" MinWidth="100" ShowInCustomizationForm="True" VisibleIndex="6"
                                            FieldName="Important" ReadOnly="true" Caption="<%$ Resources:KPI_Competency,colOldValue %>" >
                                            <%--<EditFormSettings Visible="False" />--%>
                                            <CellStyle BackColor="Info" HorizontalAlign="Center" Font-Bold="false"></CellStyle>
                                            <PropertiesTextEdit DisplayFormatString="0.#" />
                                        </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataComboBoxColumn Width="5%" MinWidth="100" FieldName="Adj_Important" VisibleIndex="7" 
                                            ShowInCustomizationForm="True" Caption="<%$ Resources:KPI_Competency,colNewValue %>" >
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                ...
                TypeName="NPOL.App_Code.Business.RefCompetencyService">
                <SelectParameters>
                    <asp:SessionParameter Name="EmpID" SessionField="EmployeeIDReview" Type="String" />
            ...
            <asp:ObjectDataSource ID="DetailOds" runat="server"
                ...
                TypeName="NPOL.App_Code.Business.EmpCompetency_DetailService">
                <SelectParameters>
                    <asp:SessionParameter Name="PeriodID" SessionField="PeriodID" Type="Int32" />
