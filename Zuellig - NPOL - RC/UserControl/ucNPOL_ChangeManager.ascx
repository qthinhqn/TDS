<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNPOL_ChangeManager.ascx.cs" Inherits="NPOL.UserControl.ucNPOL_ChangeManager" %>
    ...
    <ContentTemplate>
        ...
        <div style="margin-top: 10px;">
            ...
            <dx:ASPxGridView ID="gridChangeManager" runat="server" EnableTheming="True" Theme="SoftOrange" Width="100%"
                ...
                OnCustomButtonCallback="grid_CustomButtonCallback" OnCustomButtonInitialize="gridChangeManager_CustomButtonInitialize">
...
<asp:XmlDataSource ID="ObjectType" DataFile="~/App_Data/ObjectTypes.xml" XPath="//Score"
                    runat="server" />