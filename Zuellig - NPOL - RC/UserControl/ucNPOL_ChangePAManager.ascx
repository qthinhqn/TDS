<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNPOL_ChangePAManager.ascx.cs" Inherits="NPOL.UserControl.ucNPOL_ChangePAManager" %>
    ...
    <ContentTemplate>
                                ...
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <asp:ObjectDataSource ID="ManagerListds" runat="server"
                                            SelectMethod="GetAllPAManager"
                                            TypeName="NPOL.App_Code.Business.ChangeManagerService">
        ...
        <div style="margin-top: 10px;">
            <dx:ASPxGridView ID="gridChangeManager" runat="server" EnableTheming="True" Theme="SoftOrange" Width="100%"
                ...
                <Columns>
                    <dx:GridViewCommandColumn  VisibleIndex="0" Width="150px" Caption="Action" Visible="false">
                        <CustomButtons>
                    ...
                    <dx:GridViewDataTextColumn FieldName="ToDate" ShowInCustomizationForm="True" VisibleIndex="4" Visible ="false"
            ...
            <asp:ObjectDataSource ID="ChangeManagerOds" runat="server"
                SelectMethod="GetDataChangePAManager"
                TypeName="NPOL.App_Code.Business.ChangeManagerService">
            </asp:ObjectDataSource>
        </div>
    </ContentTemplate>
