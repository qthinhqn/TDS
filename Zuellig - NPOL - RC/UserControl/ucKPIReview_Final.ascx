<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPIReview_Final.ascx.cs" Inherits="NPOL.UserControl.ucKPIReview_Final" %>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <dx:ASPxTextBox ID="txtKpiPoint" runat="server" Text='<%# string.Format("{0:N2}", Eval("KPIRating")) %>' DisplayFormatString="N2"
                                                            OnValueChanged="txtKpiPoint_TextChanged" MaxLength="4" CssClass="txtcenter" HorizontalAlign="Center" Border-BorderColor="#96c03d"
                                                            NullText="<%$Resources:Kpi_TableTotal,lbKpiPoint%>" AutoPostBack="true">
