<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_ManagerSetKPI.ascx.cs" Inherits="NPOL.UserControl.uc_ManagerSetKPI" %>
    ...
    <ContentTemplate>
                ...
                <td>
                    <div style="float: left">
                        <dx:ASPxButton ID="btnExport" runat="server" Text="<%$Resources:AF_ManagerLevel, btnTemplate %>" Font-Bold="true" OnClick="btnExport_Click" Theme="Office2003Blue">
                            <Image Url="../images/Pictures/ExportToXLS_32x32.png">
                            </Image>
                        </dx:ASPxButton>
                    </div>
                    ...
                    <div style="margin-left: 5px; float: left">
                        <dx:ASPxButton ID="btnImport" runat="server" Text="<%$Resources:AF_ManagerLevel, btnImportExcel %>" Theme="Office2003Blue" Font-Bold="true" OnClick="btnImport_Click">
                            <Image IconID="navigation_previous_32x32office2013">
                            </Image>
                        </dx:ASPxButton>
                    </div>
        ...
        <dx:ASPxPageControl runat="server" ID="ASPxPageControl1" Width="100%" ActiveTabIndex="0" Theme="Office2010Blue"
            ...
            <TabPages>
                ...
                <%-- End Tab --%>
                <%-- Tab: Employee & KPI --%>
                <dx:TabPage Text="<%$Resources:KPI_SetKPI,Tab_2 %>">
                    <ActiveTabStyle Font-Bold="true"></ActiveTabStyle>
                    <ContentCollection>
                        <dx:ContentControl>
