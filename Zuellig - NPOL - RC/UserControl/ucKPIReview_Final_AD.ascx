<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPIReview_Final_AD.ascx.cs" Inherits="NPOL.UserControl.ucKPIReview_Final_AD" %>
...
<%--<asp:UpdatePanel ID="UpdatePanel_" runat="server">
    <ContentTemplate>--%>
<div style="width: 850px; margin: 2em auto;">
                                ...
                                <div style="float: left">
                                    <table>
                                        <tr>
                                            ...
                                            <td>&nbsp;</td>
                                            <td style="margin: 10px">
                                                <dx:ASPxButton ID="btnReturn" runat="server" Text="<%$Resources:Ribbon,liApprovalPA%>"
                                                    Font-Bold="true" Theme="Office2003Blue" OnClick="btnReturn_Click">
                                                    <Image IconID="history_undo_16x16office2013"></Image>
                                                </dx:ASPxButton>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                        ...
                                        <table class="pure-table pure-table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel2" runat="server" Text='<%# string.Format("{0:P0}", Eval("Job_Factor2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text='<%# string.Format("{0:N2}", Eval("CompetencyRating2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text='<%# string.Format("{0:N2}", Eval("Total_CompetencyRating2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text='<%# string.Format("{0:P0}", Eval("KPI_Factor2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text='<%# string.Format("{0:N2}", Eval("KPIRating")) %>'>
                                                            </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text='<%# string.Format("{0:N2}", Eval("KPIRating2")) %>' ForeColor="Red">
                                                            </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text='<%# string.Format("{0:N2}", Eval("Total_KPIRating2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text='<%# string.Format("{0:N2}", Eval("Rating_Total2")) %>' ForeColor="Red">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                            </tbody>
                                ...
                                <asp:ObjectDataSource ID="RatingOds" runat="server"
                                    ...
                                    <SelectParameters>
                                        <asp:SessionParameter Name="Procedure_Name" DefaultValue="spKPI_GetTable_rptEmpHistory_Tmp2" Type="String" />
