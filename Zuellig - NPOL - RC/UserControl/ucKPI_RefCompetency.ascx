<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_RefCompetency.ascx.cs" Inherits="NPOL.UserControl.ucKPI_RefCompetency" %>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ObjectDataSource ID="PeriodOds" runat="server"
                            ...
                            TypeName="NPOL.App_Code.Business.KPI_PeriodService" >
