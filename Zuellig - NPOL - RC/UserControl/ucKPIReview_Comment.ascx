<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPIReview_Comment.ascx.cs" Inherits="NPOL.UserControl.ucKPIReview_Comment" %>
        ...
        <dx:ASPxFormLayout ID="flDateRangePicker" runat="server" ColCount="2" RequiredMarkDisplayMode="None"
            ...
            <Items>
                <dx:LayoutGroup Caption="" ColCount="2" GroupBoxDecoration="Box">
                    <Items>
                        <dx:LayoutItem ShowCaption="true" ColSpan="1" Height="350"
                                        Caption="<%$Resources:K_PerformanceAssessment,captionComment%>">
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxMemo ID="MemoNote" runat="server" Height="300px" Width="100%"
