<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_CompetencyNotes1.ascx.cs" Inherits="NPOL.UserControl.ucKPI_CompetencyNotes1" %>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                <table>
                                    <tr>
                                        <td style="margin: 10px">
                                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="<%$Resources:Kpi_RefTarget,btSave_Calculate%>"
                                                Font-Bold="true" Theme="Office2003Blue" OnClick="btnSave_Click">
                                                <Image IconID="save_saveto_16x16office2013"></Image>
                                            </dx:ASPxButton>
                                        </td>
