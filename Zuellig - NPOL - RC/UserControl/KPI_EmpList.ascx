<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KPI_EmpList.ascx.cs" Inherits="NPOL.UserControl.KPI_EmpList" %>
...
<div class="large-9 columns">
    <table style="margin-top: 10px; margin-left: 5px; width: 100%" class="table">
        <tr>
            <td></td>
            <td>
                <asp:Label ID="lbYear" runat="server" Text="<%$Resources:K_ViewEmpKPI,lbYearID %>"></asp:Label>
            </td>
            <td colspan="3">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
    ...
    SelectCommand="GetKPI_EmpListByYear" SelectCommandType="StoredProcedure">
    <SelectParameters>
