<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_makeNews.ascx.cs" Inherits="NPOL.UserControl.uc_makeNews" %>
                ...
                <table style="width:100%; ">
                    ...
                    <tr>
                        <td>
                            ...
                            <asp:Image ID="Avatar" runat="server" Height="150px" ImageUrl="~/images/Pictures/News-Mic-iPhone-icon.png" Width="150px" />
                        </td>
                    </tr>
                </table>
            </td>
