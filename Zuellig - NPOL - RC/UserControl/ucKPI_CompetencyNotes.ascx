<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_CompetencyNotes.ascx.cs" Inherits="NPOL.UserControl.ucKPI_CompetencyNotes" %>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer runat="server">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:center ">
                                                        ...
                                                        <dx:ASPxTextBox ID="txtKpiPoint" runat="server" Text='<%# string.Format("{0:N2}", Eval("KPIRating")) %>' DisplayFormatString="N2"
                                                            ...
                                                            NullText="<%$Resources:Kpi_TableTotal,lbKpiPoint%>" NullTextStyle-Font-Size="Small" AutoPostBack="true">
                                ...
                                <asp:ObjectDataSource ID="RatingOds" runat="server"
                                    ...
                                    <SelectParameters>
                                        <asp:SessionParameter Name="Procedure_Name" DefaultValue="spKPI_GetTable_rptEmpHistory_Tmp" Type="String" />
