<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_CompetencyComment.ascx.cs" Inherits="NPOL.UserControl.ucKPI_CompetencyComment" %>
                        ...
                        <dx:LayoutItem ShowCaption="true" ColSpan="2" Height="130"
                            ...
                            <LayoutItemNestedControlCollection>
                                <dx:LayoutItemNestedControlContainer runat="server">
                                    <dx:ASPxMemo ID="ASPxMemo1" runat="server" Height="120px" Width="100%" CssClass="dotted-line"
                                        Border-BorderStyle="None" BackColor="Transparent"
                                        NullText="<%$Resources:K_PerformanceAssessment,nullText %>" MaxLength="200">
