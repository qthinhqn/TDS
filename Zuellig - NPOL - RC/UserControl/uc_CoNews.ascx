<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_CoNews.ascx.cs" Inherits="NPOL.UserControl.uc_CoNews" %>
            ...
            <tr>
                <%--<td>
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server"
                        SelectMethod="GetNewsOfCategory" TypeName="NPOL.App_Code.Business.NewsService">
