<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SelfAssessment_3.aspx.cs" Inherits="NPOL.K_SelfAssessment_3" %>
<%@ Register Src="~/UserControl/ucKPI_RequireTraining.ascx" TagPrefix="uc1" TagName="ucKPI_RequireTraining" %>
    ...
    <div style="margin: 8px 10px; ">
        <nav id="nav4Step" runat="server" >
            <ul class="cd-breadcrumb triangle custom-icons">
                ...
                <li runat="server" class="current" id="liStep_3"><a name="3" runat="server" ><dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_3%>" /></a></li>
        ...
        <uc1:ucKPI_RequireTraining runat="server" ID="ucKPI_RequireTraining" />
    </div>
