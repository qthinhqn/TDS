...
namespace NPOL
{
    public partial class PR_HRReview : System.Web.UI.Page
    {
            ...
            try
            {
                if (item != null)
                {
                    ...
                    if (item.SectionID == "ZPV")
                        ...
                        opt_G2.Checked = true;
                    else if (item.SectionID == "Sang") // SPC
                        opt_G3.Checked = true;
                    else if (item.SectionID == "Phyto") // PHT
                        opt_G4.Checked = true;
                    else if (item.SectionID == "Metro") // MHV
                        opt_G6.Checked = true;
                    else if (item.SectionID == "Casual") // LA
                        opt_G7.Checked = true;
        ...
        */
        ...
        protected void btnSua_Click(object sender, EventArgs e)
        {
            if (IsValid && item != null)
            {
                ...
                if (TextBox10.Text != "")
                    new_Obj.Probation_Sal = double.Parse(TextBox10.Text);
                if (TextBox12.Text != "")
                    new_Obj.Probation_Travel = double.Parse(TextBox12.Text);
                if (TextBox14.Text != "")
                    new_Obj.Probation_Allowance = double.Parse(TextBox14.Text);
                if (TextBox11.Text != "")
                    new_Obj.Permanent_Sal = double.Parse(TextBox11.Text);
                if (TextBox13.Text != "")
                    new_Obj.Permanent_Travel = double.Parse(TextBox13.Text);
                if (TextBox15.Text != "")
                    new_Obj.Permanent_Allowance = double.Parse(TextBox15.Text);
        ...
        protected void txtEmpOtherID_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                Khuong kh = new Khuong(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZuelligConnection"].ConnectionString);
                txtEmpOtherName.Text = kh.getEmployeeName(txtEmpOtherID.Text.Trim()); ;
            }
            catch (Exception ex)
            {
