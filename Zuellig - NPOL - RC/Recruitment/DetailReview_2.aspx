<%@ Page Title="Review" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DetailReview_2.aspx.cs" Inherits="NPOL.PR_DetailReview_2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ct1" runat="server">
    ...
    <div>
            ...
            <table class="table" style="width: 100%">
                <tr>
                    <td>
                        ...
                        <asp:Label ID="Label39" runat="server" Text="<%$Resources:RC_Registration2,lb4_7 %>" CssClass="col-lg-3 control-label3"></asp:Label>
                        <%--row 1--%>
                        <asp:Label ID="Label38" runat="server" Text="" CssClass="col-lg-12 control-label2"></asp:Label>
        ...
        <div id="Part7" runat="server" class="large-12 columns">
            <lbtitle><asp:Label ID="Label47" runat="server" Text="<%$Resources:RC_Registration,lbRemarks %> " >
                
                     </asp:Label> <i class="fa fa-pencil pull-right"></i></lbtitle>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:LinkButton runat="server" ID="btnNhapLai" CssClass="button round tiny" Font-Bold="true" Font-Size="12px"
                            Text="<%$Resources:RC_Registration,lbtThoat %>" CausesValidation="false" OnClick="btnNhapLai_Click"></asp:LinkButton>
                    </td>
                    <td></td>
                </tr>
            </table>
