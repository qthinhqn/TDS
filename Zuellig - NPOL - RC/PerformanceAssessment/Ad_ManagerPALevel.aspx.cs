    ...
    public partial class K_ManagerKPILevel : System.Web.UI.Page
    {
        ...
        protected void btnTransfer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    provider.CommandText = "Insert into tblKPIManagerLevel_tmp (EmployeeID, DateChange, SectionID, LineID, PosID, ManagerID_L1, ManagerID_L2, ManagerID_L3, ManagerID_L4) values(@EmployeeID, @DateChange, @SectionID, @LineID, @PosID, @ManagerID_L1, @ManagerID_L2, @ManagerID_L3, @ManagerID_L4)";
                    provider.ParameterCollection = new string[] { "@EmployeeID", "@DateChange", "@SectionID", "@LineID", "@PosID", "@ManagerID_L1", "@ManagerID_L2", "@ManagerID_L3", "@ManagerID_L4" };
                    ...
                    object managerid_l4 = dt.Rows[i]["ID_L4"];
                    provider.ValueCollection = new object[] { empid, datechange, sectionid, lineid, posid, managerid_l1, managerid_l2, managerid_l3, managerid_l4 };
            ...
            try
            {
                ...
                if (exceldata.Rows.Count > 0)
                {
                    for (int i = 0; i < exceldata.Rows.Count; i++)
                    {
                        ...
                        object m4 = exceldata.Rows[i][14];

                        //Thêm dữ liệu vào bảng định cấp tạm tblKPIManagerLevel_TMP
                        provider.CommandText = "Insert into tblKPIManagerLevel_tmp (EmployeeID, DateChange, SectionID, LineID, PosID, ManagerID_L1, ManagerID_L2, ManagerID_L3, ManagerID_L4) values(@EmployeeID, getdate(), @SectionID, @LineID, @PosID, @ManagerID_L1, @ManagerID_L2, @ManagerID_L3, @ManagerID_L4)";
                        provider.ParameterCollection = new string[] { "@EmployeeID", "@SectionID", "@LineID", "@PosID", "@ManagerID_L1", "@ManagerID_L2", "@ManagerID_L3", "@ManagerID_L4" };
                        provider.ValueCollection = new object[] { empid, sectionid, lineid, posid, m1, m2, m3, m4 };
                        provider.ExecuteNonQuery();
                    }
                }
        ...
        {
            //int returnValue = 0;
            Khuong kh = new Khuong(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZuelligPAConnection"].ConnectionString);
            khSqlServerProvider provider = new khSqlServerProvider(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["ZuelligPAConnection"].ConnectionString);
            ...
            else if (dt.Rows.Count > 0)
            {
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    object m4 = dt.Rows[i]["ManagerID_L4"];

                    if (!kh.IsEmployeeOT(employeeid.ToString()))
                    {
                        //Thêm mới định cấp
                        provider.CommandText = "Insert into tblKPIManagerLevel (EmployeeID, DateChange, SectionID, LineID, PosID, ManagerID_L1, ManagerID_L2, ManagerID_L3, ManagerID_L4) values(@EmployeeID, getdate(), @SectionID, @LineID, @PosID, @ManagerID_L1, @ManagerID_L2, @ManagerID_L3, @ManagerID_L4)";
                        provider.ParameterCollection = new string[] { "@EmployeeID", "@SectionID", "@LineID", "@PosID", "@ManagerID_L1", "@ManagerID_L2", "@ManagerID_L3", "@ManagerID_L4" };
                        provider.ValueCollection = new object[] { employeeid, sectionid, lineid, posid, m1, m2, m3, m4 };
                        provider.ExecuteNonQuery();
                    ...
                    else
                    {
                        ...
                        provider.CommandText = "Update tblKPIManagerLevel Set ManagerID_L1 = @L1, ManagerID_L2 = @L2, ManagerID_L3 = @L3, ManagerID_L4 = @L4 where EmployeeID = @EmpID";
                        provider.ParameterCollection = new string[] { "@L1", "@L2", "@L3", "@L4", "@EmpID" };
                        provider.ValueCollection = new object[] { m1, m2, m3, m4, employeeid };
