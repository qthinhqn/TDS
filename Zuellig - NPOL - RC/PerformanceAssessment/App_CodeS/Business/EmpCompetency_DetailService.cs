...
namespace PAOL.App_Code.Business
{
    public class EmpCompetency_DetailService
    {
        ...
        public bool UpdateScore(string EmployeeID, int PeriodID, int competency_id, float score, float important)
        {
            EmpCompetency_DetailDAO newDAO = new EmpCompetency_DetailDAO();
            return newDAO.UpdateScore(EmployeeID, PeriodID, competency_id, score, important);
        }
        public bool UpdateAdj_Score(string EmployeeID, int PeriodID, int competency_id, float score, float important)
        {
            EmpCompetency_DetailDAO newDAO = new EmpCompetency_DetailDAO();
