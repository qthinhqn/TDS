...
namespace PAOL.App_Code.Business
{
    public class Competency_KPIService
    {
        ...
        public static DataTable GetTable_rptEmpHistory(string Procedure_Name, string EmployeeID)
        {
            Competency_KPIDAO newsDAO = new Competency_KPIDAO();
            return newsDAO.GetTable_rptEmpHistory(Procedure_Name, "rptEmpKPI", EmployeeID);
        }
