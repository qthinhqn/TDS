...
namespace PAOL.App_Code.Data
{
    public class BaseDAO : DataAccessException
    {
        ...
        {
            return ConfigurationManager.ConnectionStrings["ZuelligPAConnection"].ConnectionString;
        }
        public SqlConnection GetConnection()
        {
            return new SqlConnection(ConfigurationManager.ConnectionStrings["ZuelligPAConnection"].ConnectionString);
        }
