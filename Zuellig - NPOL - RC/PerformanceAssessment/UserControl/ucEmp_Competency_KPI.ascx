<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucEmp_Competency_KPI.ascx.cs" Inherits="PAOL.UserControl.ucEmp_Competency_KPI" %>
...
<asp:PlaceHolder ID="PlaceHolder2" runat="server">
    <nav id="nav4Step" runat="server">
        <ul class="cd-breadcrumb triangle custom-icons">
            ...
            <li runat="server" id="liStep_5"><a name="5" onserverclick="Link_Click" runat="server" ><dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_5%>" /></a></li>
