<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_ManagerSetKPI.ascx.cs" Inherits="PAOL.UserControl.uc_ManagerSetKPI" %>
<%@ Register TagPrefix="dx" Namespace="DevExpress.Web" Assembly="DevExpress.Web.v15.1" %>
<%@ Register Src="~/PerformanceAssessment/UserControl/KPI_EmpList.ascx" TagPrefix="uc1" TagName="KPI_EmpList" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
                ...
                <tr>
                    <td>
                        <div style="float: left">
                            <dx:ASPxButton ID="btnExport" runat="server" Text="<%$Resources:AF_ManagerLevel, btnTemplate %>" Font-Bold="true" OnClick="btnExport_Click" Theme="Office2003Blue">
        ...
        <dx:ASPxPageControl runat="server" ID="ASPxPageControl1" Width="100%" ActiveTabIndex="0" Theme="Office2010Blue"
            OnTabClick="ASPxPageControl1_ActiveTabChanged">
            <TabPages>
                <%-- Tab: KPI List --%>
                <dx:TabPage Text="KPI List">
                    ...
                    <ContentCollection>
                        <dx:ContentControl>
                            <%--KPI list--%>
                            <dx:ASPxGridView ID="gridKPIList" ClientInstanceName="gridKPIList" runat="server" Theme="Office2010Blue" AutoGenerateColumns="False" DataSourceID="dsKPI_List"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Notes" ShowInCustomizationForm="True" VisibleIndex="5" Caption="<%$Resources:KPI_SetKPI,gvKPI_colNotes %>">
                                        <Settings AllowAutoFilter="False" />
                                        <EditFormSettings Visible="True" />
                                        <CellStyle HorizontalAlign="Left"></CellStyle>
                                    </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataColumn Name="View" ShowInCustomizationForm="True" VisibleIndex="1" Width="150" Caption="<%$Resources:KPI_SetKPI,gvKPI_colView %>">
                                        <DataItemTemplate>
                            ...
                            <asp:SqlDataSource ID="dsKPI_List" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligPAConnection %>"
            ...
            <ContentCollection>
                <dx:PopupControlContentControl runat="server">
                    <div style="margin: 12px">
                        <dx:ASPxButton ID="btnTransfer" runat="server" Text="<%$Resources:KPI_SetKPI,btnTransfer %>" Theme="Office2003Blue" Font-Bold="true" OnClick="btnTransfer_Click">
                            ...
                            <dx:SplitterPane AutoHeight="true">
                                <ContentCollection>
                                    ...
                                    <dx:SplitterContentControl runat="server" ID="RightPane" Width="70%">
                                        ...
                                        <asp:SqlDataSource ID="dsKPI_EmpList" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligPAConnection %>"
        ...
        <dx:ASPxGridViewExporter ExportedRowType="All" ID="gridExport" runat="server" GridViewID="GridKPIList"></dx:ASPxGridViewExporter>
