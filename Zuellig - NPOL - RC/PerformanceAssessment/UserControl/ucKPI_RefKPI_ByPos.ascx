<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_RefKPI_ByPos.ascx.cs" Inherits="PAOL.UserControl.ucKPI_RefKPI_ByPos" %>
    ...
    <ContentTemplate>
        ...
        <div style="margin-top: 10px; ">
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                SelectMethod="GetAllPosition" TypeName="PAOL.App_Code.Business.KPI_RefPositionService"></asp:ObjectDataSource>
            <asp:ObjectDataSource ID="DetailOds" runat="server"
                SelectMethod="GetKPI_RefPosition" DeleteMethod="DeleteByID" 
                TypeName="PAOL.App_Code.Business.KPI_RefPositionService" OnDeleting="DetailOds_Deleting">
                <SelectParameters>
