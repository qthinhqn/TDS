<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_Period.ascx.cs" Inherits="PAOL.UserControl.ucKPI_Period" EnableTheming="true" %>
                ...
                <tr>
                    ...
                    <td>
                        <dx:ASPxButton ID="btnSave" runat="server" Text="<%$Resources:Kpi_RefTarget,btSave%>" Font-Bold="true" Theme="Office2003Blue" OnClick="btnSave_Click">
                            <Image IconID="save_saveto_32x32office2013"></Image>
                        </dx:ASPxButton>
                    </td>
                    <td>
                    ...
                    <td>
                        <dx:ASPxButton ID="btCompetency" runat="server" Text="<%$Resources:KPI_Period,btCompetency%>" Font-Bold="true" Theme="Office2003Blue" OnClick="btCompetency_Click">
                            <Image IconID="tasks_edittask_32x32office2013"></Image>
                        </dx:ASPxButton>
                    </td>
                    <%--<td>
                        <dx:ASPxButton ID="btPrint" runat="server" Text="<%$Resources:KPI_Period,btPrint%>" Font-Bold="true" Theme="Office2003Blue" >
                            <Image IconID="actions_print_32x32devav"></Image>
                        </dx:ASPxButton>
                    </td>--%>
                </tr>
            </table>
        ...
        <div>
            ...
            <dx:ASPxGridView ID="gvDinhCap" runat="server" EnableTheming="True" Theme="SoftOrange" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataMemoColumn Caption="<%$Resources:KPI_Period,lbDescription%>" FieldName="Name" Width="50%" ShowInCustomizationForm="True" VisibleIndex="1">
                    </dx:GridViewDataMemoColumn>
                    <dx:GridViewDataDateColumn Caption="<%$Resources:KPI_Period,lbStarttime%>" FieldName="StartTime" Width="10%" ShowInCustomizationForm="True" VisibleIndex="2">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn Caption="<%$Resources:KPI_Period,lbReviewtime%>" FieldName="ReviewTime" Width="10%" ShowInCustomizationForm="True" VisibleIndex="3">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn Caption="<%$Resources:KPI_Period,lbApprovaltime%>" FieldName="ApprovalTime" Width="10%" ShowInCustomizationForm="True" VisibleIndex="4">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataDateColumn Caption="<%$Resources:KPI_Period,lbEndtime%>" FieldName="EndTime" Width="10%" ShowInCustomizationForm="True" VisibleIndex="5">
                    </dx:GridViewDataDateColumn>
                    <dx:GridViewDataTextColumn Caption="<%$Resources:KPI_Period,lbActive%>" FieldName="Active" ShowInCustomizationForm="True" VisibleIndex="6">
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                SelectMethod="GetAllKPI_Period" TypeName="PAOL.App_Code.Business.KPI_PeriodService"></asp:ObjectDataSource>
        </div>
    </ContentTemplate>
</asp:UpdatePanel>