<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_RefTarget.ascx.cs" Inherits="PAOL.UserControl.ucKPI_RefTarget" %>
    ...
    <ContentTemplate>
        ...
        <div>
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                SelectMethod="GetAllTargetRef" TypeName="PAOL.App_Code.Business.RefTargetService"></asp:ObjectDataSource>
        </div>
    </ContentTemplate>
</asp:UpdatePanel>