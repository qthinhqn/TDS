<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucKPI_Store.ascx.cs" Inherits="PAOL.UserControl.ucKPI_Store" %>
    ...
    <table style="width: 100%;">
        ...
        <div style="margin-top: 10px">
            ...
            <asp:ObjectDataSource ID="TargetOds" runat="server"
                SelectMethod="GetAllStore_KPI" TypeName="PAOL.App_Code.Business.Store_KPIService"></asp:ObjectDataSource>
        </div>
    </ContentTemplate>
</asp:UpdatePanel>