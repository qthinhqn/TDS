        ...
        private void LoadControlStep()
        {
            ...
            switch (current)
            {
                case 1:
                    ...
                    if (oldControl != 1)
                    {
                        ucKPI_EmpCompetency ucCompetency = LoadControl("~/PerformanceAssessment/UserControl/ucKPI_EmpCompetency.ascx") as ucKPI_EmpCompetency;
                ...
                case 2:
                    ...
                    if (oldControl != 2)
                    {
                        ucKPI_EmpKPI_Detail ucKPI = LoadControl("~/PerformanceAssessment/UserControl/ucKPI_EmpKPI_Detail.ascx") as ucKPI_EmpKPI_Detail;
                        if (ucKPI != null)
                ...
                case 3:
                    ...
                    if (oldControl != 3)
                    {
                        ucKPI_RequireTraining ucTraining = LoadControl("~/PerformanceAssessment/UserControl/ucKPI_RequireTraining.ascx") as ucKPI_RequireTraining;
                        if (ucTraining != null)
                ...
                case 4:
                    ...
                    if (oldControl != 4)
                    {
                        ucKPI_CompetencyComment ucNotes = LoadControl("~/PerformanceAssessment/UserControl/ucKPI_CompetencyComment.ascx") as ucKPI_CompetencyComment;
                        if (ucNotes != null)
                ...
                case 5:
                    ...
                    if (oldControl != 5)
                    {
                        ucKPI_CompetencyNotes ucNotes = LoadControl("~/PerformanceAssessment/UserControl/ucKPI_CompetencyNotes.ascx") as ucKPI_CompetencyNotes;
                        if (ucNotes != null)
                            Placeholder1.Controls.Add(ucNotes);
                        oldControl = 5;
                    }
