    ...
    public partial class Ad_ViewEmpKPI : System.Web.UI.Page
    {
        ...
        protected void ASPxButton2_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(ddlYearSal.Text))
            {
                ...
                Response.Redirect("~/PerformanceAssessment/Ad_ViewReportKPI.aspx");
            }
            else
            {
                string message = "alert('" + GetGlobalResourceObject("K_ViewEmpKPI", "alert").ToString() + "')";
        ...
        protected void ASPxButton3_Click(object sender, EventArgs e)
        {
            if (!String.IsNullOrEmpty(ddlYearSal.Text))
            {
                Session["rptPeiEmployeeID"] = null;
                Session["rptPeriodID"] = ddlYearSal.SelectedValue;
                Response.Redirect("~/PerformanceAssessment/Ad_ViewReportKPI_Pie.aspx");
            }
            else
            {
                string message = "alert('" + GetGlobalResourceObject("K_ViewEmpKPI", "alert").ToString() + "')";
        ...
        protected void ASPxGridView1_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
        {
            ...
            switch (e.ButtonID)
            {
                // edit news
                case "Edit":
                    message = "alert('" + GetGlobalResourceObject("K_ViewEmpKPI", "PAalert").ToString() + "')";
                    ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "alert", message, true);
                    /*
                    Competency_KPIService service = new Competency_KPIService();
                    ...
                    if (dt != null)
                    {
                        ...
                        ASPxWebControl.RedirectOnCallback("~/PAreview.aspx");
                    }
                     * */
                    break;
