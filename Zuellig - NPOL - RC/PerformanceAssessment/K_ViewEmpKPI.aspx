<%@ Page Title="Pay slip" Language="C#" MasterPageFile="~/PerformanceAssessment/Site1.Master" AutoEventWireup="true" CodeBehind="K_ViewEmpKPI.aspx.cs" Inherits="PAOL.K_ViewEmpKPI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ct1" runat="server">
    ...
    <div style="margin: 8px 10px;">
        ...
        <div>
            <asp:SqlDataSource ID="DetailOds" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligPAConnection %>"
