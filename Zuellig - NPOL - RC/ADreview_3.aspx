<%@ Page Title="" Language="C#" MasterPageFile="~/SitePA.Master" AutoEventWireup="true" CodeBehind="ADreview_3.aspx.cs" Inherits="NPOL.K_PerformanceAssessment_ADReview_3" %>

<%@ Register Src="~/UserControl/ucKPIReview_RequireTraining.ascx" TagPrefix="uc1" TagName="ucKPIReview_RequireTraining" %>
    ...
    <div style="margin: 8px 10px; font-family: Tahoma;">
        <nav id="nav4Step" runat="server">
            <ul class="cd-breadcrumb triangle custom-icons">
                <li runat="server" id="liStep_1"><a name="1" href="ADreview_1.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_1%>" />
                </a></li>
                <li runat="server" id="liStep_2"><a name="2" href="ADreview_2.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_2%>" />
                </a></li>
                <li runat="server" class="current" id="liStep_3"><a name="3" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_3%>" />
                </a></li>
                <li runat="server" id="liStep_4"><a name="4" href="ADreview_4.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_4%>" />
                </a></li>
                <li runat="server" id="liStep_5"><a name="5" href="ADreview_5.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_5%>" />
                </a></li>
            </ul>
        </nav>

        <uc1:ucKPIReview_RequireTraining runat="server" ID="ucKPIReview_RequireTraining" />
    </div>
