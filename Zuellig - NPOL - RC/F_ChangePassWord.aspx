                    ...
                    <div class="large-9 columns">
                        <table id="mk" class="table" style="width: 100%">
                            ...
                            <tr style="margin-bottom: 0; padding-bottom: 0">
                                <td></td>
                                <td>
                                    <asp:LinkButton ID="lbtPayslip" runat="server" Text="<%$Resources:F_ChangePassword,btnPayslip %>" CssClass="button round tiny" Font-Bold="true" Font-Size="12px" OnClick="lbtPayslip_Click"></asp:LinkButton>
                            ...
                            <tr style="margin-bottom: 0; padding-bottom: 0">
                                ...
                                <td>
                                    ...
                                    <asp:LinkButton ID="lbtQuenPass" runat="server" Text="<%$Resources:F_ChangePassword,btnQuenPass %>" CssClass="button round tiny" Font-Bold="true" Font-Size="12px" OnClick="lbtQuenPass_Click" CausesValidation="false"></asp:LinkButton>
                                </td>
                            </tr>
                        </table>
                    </div>
