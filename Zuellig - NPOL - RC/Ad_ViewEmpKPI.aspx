<%@ Page Language="C#" MasterPageFile="~/SitePA.Master" AutoEventWireup="true" CodeBehind="Ad_ViewEmpKPI.aspx.cs" Inherits="NPOL.Ad_ViewEmpKPI" %>
                                        ...
                                        <dx:ASPxGridView ID="gridRating" ClientInstanceName="gv" runat="server" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewCommandColumn Name="CommandCol" Caption="<%$Resources:N_ListNews,colAction%>" MinWidth="170" Width="170"
                                                    ...
                                                    <CustomButtons>
                                                        <dx:GridViewCommandColumnCustomButton ID="Edit" Text="<%$Resources:K_ViewEmpKPI,btEdit%>">
