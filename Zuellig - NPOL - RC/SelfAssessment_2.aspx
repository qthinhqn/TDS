<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SelfAssessment_2.aspx.cs" Inherits="NPOL.K_SelfAssessment_2" %>
<%@ Register Src="~/UserControl/ucKPI_EmpKPI_Detail.ascx" TagPrefix="uc1" TagName="ucKPI_EmpKPI_Detail" %>
    ...
    <div style="margin: 8px 10px; ">
        <nav id="nav4Step" runat="server" >
            <ul class="cd-breadcrumb triangle custom-icons">
                ...
                <li runat="server" class="current" id="liStep_2"><a name="2" runat="server" ><dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_2%>" /></a></li>
        ...
        <uc1:ucKPI_EmpKPI_Detail runat="server" ID="ucKPI_EmpKPI_Detail" />
    </div>
