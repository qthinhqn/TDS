<%@ Page Title="" Language="C#" MasterPageFile="~/SitePA.Master" AutoEventWireup="true" CodeBehind="ADreview_4.aspx.cs" Inherits="NPOL.K_PerformanceAssessment_ADReview_4" %>

<%@ Register Src="~/UserControl/ucKPIReview_Comment.ascx" TagPrefix="uc1" TagName="ucKPIReview_Comment" %>
    ...
    <div style="margin: 8px 10px; font-family: Tahoma;">
        <nav id="nav4Step" runat="server">
            <ul class="cd-breadcrumb triangle custom-icons">
                ...
                <li runat="server" class="current" id="liStep_4"><a name="4" runat="server">
        ...
        <uc1:ucKPIReview_Comment runat="server" ID="ucKPIReview_Comment" />
    </div>
