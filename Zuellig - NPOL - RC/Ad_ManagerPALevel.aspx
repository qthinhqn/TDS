<%@ Page Title="" Language="C#" MasterPageFile="~/SitePA.Master" AutoEventWireup="true" CodeBehind="Ad_ManagerPALevel.aspx.cs" Inherits="NPOL.K_ManagerKPILevel" %>

<%@ Register Assembly="DevExpress.Web.v15.1, Version=15.1.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Src="~/UserControl/ucNPOL_ChangePAManager.ascx" TagPrefix="uc1" TagName="ucNPOL_ChangePAManager" %>
                            ...
                            <div>
                                <dx:ASPxGridView ID="gvDinhCap" runat="server" AutoGenerateColumns="False" DataSourceID="dsDinhCap" KeyFieldName="EmployeeID" EnableTheming="True" Theme="Office2003Blue" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="LineID" ShowInCustomizationForm="True" VisibleIndex="3" Caption="<%$Resources:AF_ManagerLevel, col_Line %>" Width="150">
                                            <PropertiesComboBox DataSourceID="dsSubDep" TextField="LineName" ValueField="LineID"></PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>

                                        <dx:GridViewDataComboBoxColumn FieldName="DepID" ShowInCustomizationForm="True" VisibleIndex="4" Caption="<%$Resources:AF_ManagerLevel, col_Sec %>" Width="150">
                                            <PropertiesComboBox DataSourceID="dsDep" TextField="DepName" ValueField="DepID"></PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
                                ...
                                <asp:SqlDataSource ID="dsDinhCap" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
                                    SelectCommand="spKPI_ManagerLevel" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                ...
                                <asp:SqlDataSource ID="dsDep" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
                                    SelectCommand="SELECT DISTINCT DepID, DepName from tblRef_Department where DepTypeID='G'"></asp:SqlDataSource>
                                ...
                                <%--<asp:SqlDataSource ID="dsM4" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
                        ...
                        <dx:ContentControl>
                            ...
                            <div style="margin-top: 5px">
                                ...
                                <asp:SqlDataSource ID="dsDinhCapTMP" runat="server" ConnectionString="<%$ ConnectionStrings:ZuelligConnection %>"
                                    ...
                                    InsertCommand="INSERT INTO dbo.tblKPIManagerLevel_tmp(EmployeeID, DateChange, SectionID, LineID, PosID, ManagerID_L1, ManagerID_L2, ManagerID_L3, ManagerID_L4) VALUES (UPPER(@EmployeeID), getdate(), @SectionID, @LineID, @PosID, UPPER(@ManagerID_L1), UPPER(@ManagerID_L2), UPPER(@ManagerID_L3), NULL)"
                                    ...
                                    UpdateCommand="UPDATE [tblKPIManagerLevel_tmp] SET [ManagerID_L1] = UPPER(@ManagerID_L1), [ManagerID_L2] = UPPER(@ManagerID_L2), [ManagerID_L3] = UPPER(@ManagerID_L3), [ManagerID_L4] = NULL  WHERE [EmployeeID] = @EmployeeID">
                                    <DeleteParameters>
