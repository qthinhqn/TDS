<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SelfAssessment_1.aspx.cs" Inherits="NPOL.K_SelfAssessment_1" %>

<%@ Register Src="~/UserControl/ucKPI_EmpCompetency.ascx" TagPrefix="uc1" TagName="ucKPI_EmpCompetency" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ct1" runat="server">
    ...
    <style type="text/css">
        .msg.info {
            background: url("../img/ico-info.gif") 10px 50% no-repeat;
    ...
    <div style="margin: 8px 10px;">
        <nav id="nav4Step" runat="server">
            <ul class="cd-breadcrumb triangle custom-icons">
                ...
                <li runat="server" id="liStep_2"><a name="2" href="SelfAssessment_2.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_2%>" />
                </a></li>
                <li runat="server" id="liStep_3"><a name="3" href="SelfAssessment_3.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_3%>" />
                </a></li>
                <li runat="server" id="liStep_4"><a name="4" href="SelfAssessment_4.aspx" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_4%>" />
                </a></li>
                <li runat="server" id="liStep_5"><a name="5" href="SelfAssessment_5.aspx" runat="server">
        ...
        <uc1:ucKPI_EmpCompetency runat="server" ID="ucKPI_EmpCompetency" />
    </div>
