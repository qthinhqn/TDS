            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="registrationform">
                    <div class="form-horizontal">
                        <fieldset>
                            <legend>
                                <asp:Label ID="Label3" runat="server" Text="<%$Resources:login,lbForm %>"></asp:Label>
                                <i class="fa fa-pencil pull-right"></i></legend>
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <asp:TextBox ID="txtUserName" runat="server" placeholder="EmpID / Email" CssClass="form-control" OnTextChanged="txtUserName_TextChanged"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <asp:Label runat="server" ID="lblOldEmployee" Text="" ForeColor="Red" DisplayMode="BulletList"></asp:Label>
