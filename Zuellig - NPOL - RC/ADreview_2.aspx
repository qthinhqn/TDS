<%@ Page Title="" Language="C#" MasterPageFile="~/SitePA.Master" AutoEventWireup="true" CodeBehind="ADreview_2.aspx.cs" Inherits="NPOL.K_PerformanceAssessment_ADReview_2" %>

<%@ Register Src="~/UserControl/ucKPIReview_EmpKPI_Detail.ascx" TagPrefix="uc1" TagName="ucKPIReview_EmpKPI_Detail" %>
    ...
    <div style="margin: 8px 10px; font-family: Tahoma;">
        <nav id="nav4Step" runat="server">
            <ul class="cd-breadcrumb triangle custom-icons">
                ...
                <li runat="server" class="current" id="liStep_2"><a name="2" runat="server">
                    <dx:ASPxLabel runat="server" Text="<%$Resources:KPI_TitlePage,lbStep_2%>" />
                </a></li>
                <li runat="server" id="liStep_3"><a name="3" href="ADreview_3.aspx" runat="server">
        ...
        <uc1:ucKPIReview_EmpKPI_Detail runat="server" ID="ucKPIReview_EmpKPI_Detail" />
    </div>
