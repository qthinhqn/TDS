<%@ Page Title="Leave report" Language="C#" MasterPageFile="~/SiteHR.Master" AutoEventWireup="true" CodeBehind="AF_LeaveReportNew.aspx.cs" Inherits="NPOL.AF_LeaveReportNew" %>
                ...
                <div class="row">
                    <div class="large-7 columns">
                        <table style="margin-top: 10px; margin-left: 5px; width: 100%" class="table">
                            <tr>
                                <td class="auto-style1" style="width:120px !important">
                    ...
                    <div class="large-5 columns" style="margin-top: 5px">
