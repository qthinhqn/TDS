<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="RptNhapFE3List.aspx.cs" Inherits="Serene3.Reports.CrystalViewer.RptNhapFE3List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>
        <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:RptXuatFEList, lblTitle_rpt1%>" />
    </h1>
