namespace Serene3.SpringPrintingConnection {
    export interface TblXuongChuyenInChiTietRow {
        KeyId?: number;
        MaBo?: number;
        Ngay?: string;
    ...
    export namespace TblXuongChuyenInChiTietRow {
        export const idProperty = 'KeyId';
        export const localTextPrefix = 'SpringPrintingConnection.TblXuongChuyenInChiTiet';
