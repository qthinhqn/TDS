namespace Serene3.SpringPrintingConnection {
    export interface TblHopDong_DieuChinhRow {
        KeyId?: number;
        MaHd?: number;
        SlNhan?: number;
        SlNhanHu?: number;
    ...
    export namespace TblHopDong_DieuChinhRow {
        export const idProperty = 'KeyId';
        export const localTextPrefix = 'SpringPrintingConnection.TblHopDong_DieuChinh';
