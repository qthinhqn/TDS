...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [ConnectionKey("SpringPrintingConnection"), Module("SpringPrintingConnection"), TableName("[dbo].[vChiTiet_BTP]")]
    [DisplayName("V Chi Tiet Btp"), InstanceName("V Chi Tiet Btp")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript]
    public sealed class VChiTietBtpRow : Row, IIdRow, INameRow
    {
        ...
        //[DisplayName("MaBTP_ID"), Column("MaBTP_ID"), Size(50)]
        //public String MaBTP_ID
        //{
        //    get { return Fields.MaBTP_ID[this]; }
        //    set { Fields.MaBTP_ID[this] = value; }
        //}
        //[DisplayName("MaSizeID"), Size(50)]
        //public String MaSizeID
        //{
        //    get { return Fields.MaSizeID[this]; }
        //    set { Fields.MaSizeID[this] = value; }
        //}

        //[DisplayName("MaStyleID"), Size(50)]
        //public String MaStyleID
        //{
        //    get { return Fields.MaStyleID[this]; }
        //    set { Fields.MaStyleID[this] = value; }
        //}
        ...
        {
            get { return Fields.MaBtp; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public VChiTietBtpRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            //public Int32Field MaBTP_ID;
            //public Int32Field MaSizeID;
            //public Int32Field MaStyleID;
        }
    }
}
