...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [DisplayName("V Chi Tiet Btp Style Color"), InstanceName("V Chi Tiet Btp Style Color")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript]
    public sealed class VChiTietBtp_Style_ColorRow : Row, IIdRow, INameRow
    {
        ...
        {
            get { return Fields.MaMau; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public VChiTietBtp_Style_ColorRow()
            : base(Fields)
        {
        }
