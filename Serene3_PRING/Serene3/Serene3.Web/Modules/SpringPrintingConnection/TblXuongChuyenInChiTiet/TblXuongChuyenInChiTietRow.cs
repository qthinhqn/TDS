...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [ConnectionKey("SpringPrintingConnection"), Module("SpringPrintingConnection"), TableName("[dbo].[tblXuongChuyenIn_ChiTiet]")]
    [DisplayName("Tbl Xuong Chuyen In Chi Tiet"), InstanceName("Tbl Xuong Chuyen In Chi Tiet")]
    //[ReadPermission("Administration:General")]
    //[ModifyPermission("Administration:General")]
    [ReadPermission(PermissionKeys.TblXuongChuyenInChiTiet.View)]
    [ModifyPermission(PermissionKeys.TblXuongChuyenInChiTiet.Modify)]
    [DeletePermission(PermissionKeys.TblXuongChuyenInChiTiet.Delete)]
    [LeftJoin("cd", "vChiTiet_BTP", "cd.[KeyID_1] = T0.[MaBo]")]
    [LeftJoin("vNK", "vNhapKho_SP", "vNK.[Expr1] = T0.[MaBo]")]
    public sealed class TblXuongChuyenInChiTietRow : Row, IIdRow
    {
        ...
        [DisplayName("Ma Xuong Chuyen"), ForeignKey("[dbo].[tblXuongChuyen]", "KeyID"), LeftJoin("jMaXuongChuyen")]
        ...
        public Int32? LoiIn
        {
            get { return Fields.LoiIn[this]; }
            set { Fields.LoiIn[this] = value; }
        }
        ...
        [DisplayName("Ma Xuong Chuyen Ma Nv Quet"), Expression("jMaXuongChuyen.[MaNV_Quet]")]
        public Int32? MaXuongChuyenMaNvQuet
        {
            get { return Fields.MaXuongChuyenMaNvQuet[this]; }
            set { Fields.MaXuongChuyenMaNvQuet[this] = value; }
        }

        [DisplayName("Ma Xuong Chuyen Ngay"), Expression("jMaXuongChuyen.[Ngay]")]
        public DateTime? MaXuongChuyenNgay
        {
            get { return Fields.MaXuongChuyenNgay[this]; }
            set { Fields.MaXuongChuyenNgay[this] = value; }
        }
        ...
        public TblXuongChuyenInChiTietRow()
            : base(Fields)
        {
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field MaXuongChuyenMaNvQuet;
            public DateTimeField MaXuongChuyenNgay;
