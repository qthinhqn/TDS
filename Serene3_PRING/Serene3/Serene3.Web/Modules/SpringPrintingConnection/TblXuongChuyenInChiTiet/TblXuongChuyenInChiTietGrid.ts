...
namespace Serene3.SpringPrintingConnection {
    ...
    export class TblXuongChuyenInChiTietGrid extends Serenity.EntityGrid<TblXuongChuyenInChiTietRow, any> {
        ...
        getButtons() {
            ...
            buttons.push(Serene3.Common.ExcelExportHelper.createToolButton({
                ...
                service: TblXuongChuyenInChiTietService.baseUrl + '/ListExcel',
                separator: true
            }));
            ...
            this.month = Serenity.Widget.create({
                ...
                init: w => w.change(x => {
                    ...
                    if (this.sMaLo111 != "" && this.sMaLo111 != undefined) {
                        TblXuongChuyenInChiTietService.GetData(
                            {
                                Note: w.value.toString(),//.toString()
                                MaXuongChuyen: this.sMaLo111
                            },
                            response => {
        ...
        protected getQuickFilters() {
            ...
            let fld = Serene3.SpringPrintingConnection.TblXuongChuyenInChiTietRow.Fields;
            //alert(this.sMaLo);
            ...
            var MaloFilter = Q.first(filters, x => x.field == fld.MaXuongChuyen);
            MaloFilter.handler = h => {
                if ((h.value == "" || h.value == null) && this.sMaLo != undefined) {
                    h.request.EqualityFilter[fld.MaXuongChuyen] = this.sMaLo;// h.value;
                }
                else {
                    h.request.EqualityFilter[fld.MaXuongChuyen] = h.value;// h.value;
                }
                if (h.active) {
                    ...
                    if (this.sMaLo == undefined) {
                        h.request.EqualityFilter[fld.MaXuongChuyen] = null
                            ;
                        this.sMaLo111 = "";
                    }
                }
