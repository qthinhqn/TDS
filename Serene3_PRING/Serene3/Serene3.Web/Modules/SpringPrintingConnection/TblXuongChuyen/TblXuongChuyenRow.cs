...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [ConnectionKey("SpringPrintingConnection"), Module("SpringPrintingConnection"), TableName("[dbo].[tblXuongChuyen]")]
    [DisplayName("Tbl Xuong Chuyen"), InstanceName("Tbl Xuong Chuyen")]
    //[ReadPermission("Administration:General")]
    //[ModifyPermission("Administration:General")]
    [ReadPermission(PermissionKeys.TblXuongChuyen.View)]
    [ModifyPermission(PermissionKeys.TblXuongChuyen.Modify)]
    [DeletePermission(PermissionKeys.TblXuongChuyen.Delete)]
    public sealed class TblXuongChuyenRow : Row, IIdRow
    {
        ...
        [DisplayName("Details"), MasterDetailRelation(foreignKey: "MaXuongChuyen", IncludeColumns = "CT_MaBTP,CT_MaMau,CT_MaSize,CT_MaStyle,CT_SL_Thuc,CT_SL_Loi_KH,CT_SL_Loi_In"), NotMapped]
        public List<TblXuongChuyenIn_ChiTietRow> DetailList
        {
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<TblXuongChuyenIn_ChiTietRow> DetailList;
        }
    }
}
