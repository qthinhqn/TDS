...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [ConnectionKey("SpringPrintingConnection"), Module("SpringPrintingConnection"), TableName("[dbo].[tbl_XuatKho_ChiTiet]")]
    [DisplayName("Tbl Xuat Kho Chi Tiet"), InstanceName("Tbl Xuat Kho Chi Tiet")]
    //[ReadPermission("Administration:General")]
    //[ModifyPermission("Administration:General")]
    [ReadPermission(PermissionKeys.TblXuatKhoChiTiet.View)]
    [ModifyPermission(PermissionKeys.TblXuatKhoChiTiet.Modify)]
    [DeletePermission(PermissionKeys.TblXuatKhoChiTiet.Delete)]
    [LeftJoin("cd", "vChiTiet_BTP", "cd.[KeyID_1] = T0.[MaBo]")]
    [LeftJoin("vNK", "vNhapKho_SP", "vNK.[Expr1] = T0.[MaBo]")]
    public sealed class TblXuatKhoChiTietRow : Row, IIdRow
    {
        ...
        [DisplayName("Ma Phieu Xuat"), ForeignKey("[dbo].[tbl_XuatKho_KH]", "KeyID"), LeftJoin("jMaPhieuXuat"), TextualField("MaPhieuXuatSoPhieu")]
        public Int32? MaPhieuXuat
        {
            get { return Fields.MaPhieuXuat[this]; }
            set { Fields.MaPhieuXuat[this] = value; }
        }
        ...
        [DisplayName("Ma Phieu Xuat Ma Kh"), Expression("jMaPhieuXuat.[MaKH]")]
        public Int32? MaPhieuXuatMaKh
        {
            get { return Fields.MaPhieuXuatMaKh[this]; }
            set { Fields.MaPhieuXuatMaKh[this] = value; }
        }

        [DisplayName("Ma Phieu Xuat Ngay Xuat"), Expression("jMaPhieuXuat.[NgayXuat]")]
        public DateTime? MaPhieuXuatNgayXuat
        {
            get { return Fields.MaPhieuXuatNgayXuat[this]; }
            set { Fields.MaPhieuXuatNgayXuat[this] = value; }
        }

        [DisplayName("Ma Phieu Xuat Ma Nv Xuat"), Expression("jMaPhieuXuat.[MaNV_Xuat]")]
        public Int32? MaPhieuXuatMaNvXuat
        {
            get { return Fields.MaPhieuXuatMaNvXuat[this]; }
            set { Fields.MaPhieuXuatMaNvXuat[this] = value; }
        }

        [DisplayName("Ma Phieu Xuat So Phieu"), Expression("jMaPhieuXuat.[SoPhieu]")]
        public String MaPhieuXuatSoPhieu
        {
            get { return Fields.MaPhieuXuatSoPhieu[this]; }
            set { Fields.MaPhieuXuatSoPhieu[this] = value; }
        }

        [DisplayName("Ma Phieu Xuat Ghichu"), Expression("jMaPhieuXuat.[Ghichu]")]
        public String MaPhieuXuatGhichu
        {
            get { return Fields.MaPhieuXuatGhichu[this]; }
            set { Fields.MaPhieuXuatGhichu[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field MaPhieuXuatMaKh;
            public DateTimeField MaPhieuXuatNgayXuat;
            public Int32Field MaPhieuXuatMaNvXuat;
            public StringField MaPhieuXuatSoPhieu;
            public StringField MaPhieuXuatGhichu;
