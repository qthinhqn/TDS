...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [LookupScript]
    public sealed class TblHopDongChiTietRow : Row, IIdRow
    {
        ...
        [DisplayName("Ma Hd"), Column("MaHD"), ForeignKey("[dbo].[tblHopDong]", "KeyID"), LeftJoin("jMaHd"), TextualField("MaHdNoiDung"), Updatable(false)]
        public Int32? MaHd
        {
        ...
        [DisplayName("Thanh Tien"), NotNull]
        ...
        //[DisplayName("Adjust Detail"), MasterDetailRelation(foreignKey: "MaChiTietHd"), NotMapped]
        //public List<TblHopDongDieuChinhRow> AdjDetailList
        //{
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            //public RowListField<TblHopDongDieuChinhRow> AdjDetailList;
        }
    }
}
