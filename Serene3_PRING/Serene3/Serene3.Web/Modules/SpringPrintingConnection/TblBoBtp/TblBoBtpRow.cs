...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [ReadPermission(PermissionKeys.TblBoBtp.View)]
    [ModifyPermission(PermissionKeys.TblBoBtp.Modify)]
    [DeletePermission(PermissionKeys.TblBoBtp.Delete)]
    public sealed class TblBoBtpRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Ma Fe Stock Out"), Column("MaFE_StockOut"), ForeignKey("[dbo].[tblFE_StockOutInfo]", "RecID"), LeftJoin("jStockOut")]
        ...
        [DisplayName("Bul No"), Expression("jStockOut.[BulNo]")]
        public Int32? BulNo
        {
        ...
        [DisplayName("Table Num"), Expression("jStockOut.[TableNum]")]
        ...
        [DisplayName("Fepo"), Expression("jStockOut.[FEPO]")]
        public String Fepo
        {
