...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [DisplayName("V Chi Tiet Btp Style"), InstanceName("V Chi Tiet Btp Style")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript]
    public sealed class VChiTietBtp_StyleRow : Row, IIdRow, INameRow
    {
        ...
        {
            get { return Fields.MaStyle; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public VChiTietBtp_StyleRow()
            : base(Fields)
        {
        }
