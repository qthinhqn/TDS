...
namespace Serene3.SpringPrintingConnection.Columns
{
    ...
    [ColumnsScript("SpringPrintingConnection.VChiTietBtp_Style")]
    [BasedOnRow(typeof(Entities.VChiTietBtp_StyleRow), CheckNames = true)]
    public class VChiTietBtp_StyleColumns
    {
