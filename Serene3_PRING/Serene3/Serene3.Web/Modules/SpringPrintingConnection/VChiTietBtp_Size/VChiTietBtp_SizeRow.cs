...
namespace Serene3.SpringPrintingConnection.Entities
{
    ...
    [DisplayName("V Chi Tiet Btp Size"), InstanceName("V Chi Tiet Btp Size")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    [LookupScript]
    public sealed class VChiTietBtp_SizeRow : Row, IIdRow, INameRow
    {
        ...
        {
            get { return Fields.MaSize; }
        }

        public static readonly RowFields Fields = new RowFields().Init();

        public VChiTietBtp_SizeRow()
            : base(Fields)
        {
        }
