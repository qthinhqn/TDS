...
{
    public partial class RptXuongChuyenFEList : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                // store procedure
                SqlCommand mySelectCommand = new System.Data.SqlClient.SqlCommand("spThongKe_XuongChuyen", thisConnection);
                ...
                //Report path
                string reportPath = Server.MapPath("~/Modules/Reports/Report/rptXuongChuyenFE.rpt");
