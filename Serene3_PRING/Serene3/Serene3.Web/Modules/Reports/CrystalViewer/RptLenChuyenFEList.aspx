<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Shared/ReportSite.Master" CodeBehind="RptLenChuyenFEList.aspx.cs" Inherits="Serene3.Reports.CrystalViewer.RptLenChuyenFEList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1>
        <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:RptXuatFEList, lblTitle_rpt4%>" />
    </h1>
