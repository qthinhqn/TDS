...
{
    public partial class RptNhapFE3List : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                // store procedure
                SqlCommand mySelectCommand = new System.Data.SqlClient.SqlCommand("spThongKe_NhapKho", thisConnection);
                ...
                string reportPath = Server.MapPath("~/Modules/Reports/Report/rptNhapFE_3.rpt");
                reportDocument.Load(reportPath);
                reportDocument.SetDataSource(objDataSet.Tables[0]);
                // You can pass parameter in your store procedure if you need
                //reportDocument.SetParameterValue("?MaHD", DropDownList2.SelectedValue);
                //reportDocument.SetParameterValue("?MaBTP", DropDownList3.SelectedValue);
