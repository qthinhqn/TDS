...
{
    public partial class RptLenChuyenFEList : System.Web.UI.Page
    {
        ...
        private void LoadReport()
        {
            try
            {
                ...
                // store procedure
                SqlCommand mySelectCommand = new System.Data.SqlClient.SqlCommand("spThongKe_LenChuyen", thisConnection);
                ...
                //Report path
                string reportPath = Server.MapPath("~/Modules/Reports/Report/rptLenChuyenFE.rpt");
