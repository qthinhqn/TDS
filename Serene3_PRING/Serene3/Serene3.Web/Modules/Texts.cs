    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Spring Printing Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to Spring Printing";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Spring Printing Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Spring Printing";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Spring Printing";
        }
