<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AF_HRNew.aspx.cs" Inherits="NPOL.AF_HRNew" %>
    ...
    <%--<asp:UpdatePanel runat="server">
        <ContentTemplate>--%>
            ...
            <div style="margin: 5px">
                <dx:ASPxGridView ID="gvHR" runat="server" AutoGenerateColumns="False" DataSourceID="dsHR" EnableTheming="True" KeyFieldName="ID" Theme="Office2003Blue"
                    Width="100%" OnHtmlRowPrepared="gvHR_HtmlRowPrepared" OnCommandButtonInitialize="gvHR_CommandButtonInitialize" OnCustomColumnDisplayText="gvHR_CustomColumnDisplayText"
                    OnRowUpdating="gvHR_RowUpdating" OnSelectionChanged="gvHR_SelectionChanged" OnRowDeleting="gvHR_RowDeleting">
                    <Settings ShowFilterRow="True" HorizontalScrollBarMode="Auto" VerticalScrollBarMode="Auto" VerticalScrollableHeight="300" ShowFilterRowMenu="true" />
                    ...
                    <Columns>
                        <dx:GridViewCommandColumn ShowClearFilterButton="True" VisibleIndex="0" Caption="<%$Resources:AF_HRNew,select %>" ShowSelectCheckbox="True" Width="50">
                        </dx:GridViewCommandColumn>
                        <dx:GridViewCommandColumn ShowEditButton="True" ShowDeleteButton="true" VisibleIndex="1" Caption=">>>" Width="150">
                        </dx:GridViewCommandColumn>
                ...
                <asp:SqlDataSource ID="dsHR" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" SelectCommand="SELECT dbo.tblWebData.ID, dbo.tblEmployee.EmployeeName, dbo.tblEmployee.LineName, dbo.tblEmployee.PosName, dbo.tblRef_LeaveType.LeaveType, dbo.tblPerTime.PerTimeName, dbo.tblWebData.LeaveReason, dbo.tblWebData.StartDate, dbo.tblWebData.ToDate, dbo.tblWebData.TotalDays, dbo.tblWebData.FromTime, dbo.tblWebData.ToTime, dbo.tblWebData.TotalHours, dbo.tblWebData.HRCheckingDate, dbo.tblWebData.HRCheckingReason, dbo.tblWebData.HRCheckingStatus, dbo.tblWebData.FinalDate, dbo.tblWebData.FinalStatus, dbo.tblWebData.HRview, dbo.tblEmployee.SalaryTypeName, dbo.tblWebData.EmployeeID, dbo.tblWebData.LeaveID, dbo.tblWebData.PerTimeID FROM dbo.tblWebData LEFT OUTER JOIN dbo.tblPerTime ON dbo.tblWebData.PerTimeID = dbo.tblPerTime.PerTimeID LEFT OUTER JOIN dbo.tblRef_LeaveType ON dbo.tblWebData.LeaveID = dbo.tblRef_LeaveType.LeaveID LEFT OUTER JOIN dbo.tblEmployee ON dbo.tblWebData.EmployeeID = dbo.tblEmployee.EmployeeID ORDER BY dbo.tblWebData.HRview"></asp:SqlDataSource>
            </div>
            <div style="margin: 5px">
                ...
                <div style="float: left; margin-left: 3px; ">
                    <dx:ASPxButton ID="btnReturn" runat="server" Text="<%$Resources:AF_HRNew,return %>" Theme="Office2003Blue" Font-Bold="true" OnClick="btnReturn_Click">
                        <Image IconID="history_undo_32x32office2013"></Image>
                    </dx:ASPxButton>
                </div>
                <div style="float: left; margin-left: 3px">
