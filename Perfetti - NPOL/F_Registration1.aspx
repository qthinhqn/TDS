...
<asp:Content ID="Content1" ContentPlaceHolderID="ct1" runat="server">
    ...
    <div id="tieude">
        <asp:Label ID="lbTieuDe" runat="server" Text="<%$Resources:F_Registration1,tieude%>"></asp:Label>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div style="float: left; width: 98%">
                                    <dx:ASPxComboBox runat="server" ID="drLoainghi" DataSourceID="LoaiPhepDS" TextField="LeaveType" ValueField="LeaveID" Width="100%" Theme="Office2010Blue" AutoPostBack="true" OnSelectedIndexChanged="drLoainghi_SelectedIndexChanged"></dx:ASPxComboBox>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:SqlDataSource ID="LoaiNghiDS" runat="server"
                                    ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                    SelectCommand="SELECT [PerTimeID], [PerTimeName] FROM [tblPerTime] where [PerTimeID] <> @PerTimeID">
                                    <SelectParameters>
            ...
            <div id="Master" style="margin: 10px">
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableCallBacks="False"
                ...
                " />
                    ...
                    <SettingsCommandButton>
                        ...
                        <EditButton ButtonType="Button" Text="<%$Resources:F_Registration1,gv_Edit%>" Image-ToolTip="<%$Resources:AF_Approval,gv_Edit%>" Styles-Style-HoverStyle-Font-Bold="true">
                    ...
                    <Columns>
                        <%--<dx:GridViewCommandColumn ShowDeleteButton="True" ShowEditButton="true" VisibleIndex="0" Width="100" Caption=">>>" FixedStyle="Left" ShowClearFilterButton="True">
                        </dx:GridViewCommandColumn>--%>
                        <dx:GridViewCommandColumn Width="100" Caption=">>>" FixedStyle="Left" ShowClearFilterButton="True">
                            <CustomButtons>
                                <dx:GridViewCommandColumnCustomButton ID="Edit" Text="<%$Resources:F_Registration1,gv_Edit%>">
                                    <Image IconID="edit_edit_16x16" ToolTip="<%$Resources:F_Registration1,gv_Edit%>" />
                                </dx:GridViewCommandColumnCustomButton>
                                <dx:GridViewCommandColumnCustomButton ID="Delete" Text="<%$Resources:F_Registration2,gv_Delete%>">
                                    <Image IconID="actions_cancel_16x16" ToolTip="<%$Resources:F_Registration2,gv_Delete%>" />
                                </dx:GridViewCommandColumnCustomButton>
                            </CustomButtons>
                        </dx:GridViewCommandColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="LeaveType" VisibleIndex="5" Caption="<%$Resources:F_Registration1,gv_LeaveType%>" Width="150">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="PerTimeName" VisibleIndex="6" Caption="<%$Resources:F_Registration1,gv_PerTimeName%>">
                        </dx:GridViewDataTextColumn>
