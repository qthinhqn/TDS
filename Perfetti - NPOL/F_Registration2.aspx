                    ...
                    <table class="table" style="width: auto">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:SqlDataSource ID="LeaveType_DS" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:SqlDataSource ID="PerTime_DS" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" SelectCommand="SELECT [PerTimeID], [PerTimeName] FROM [tblPerTime] WHERE (([PerTimeID] = @PerTimeID) OR ([PerTimeID] = @PerTimeID2))">
                                    <SelectParameters>
