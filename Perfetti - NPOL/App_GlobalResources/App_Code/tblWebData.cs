...
namespace NPOL
{
    public class tblWebData
    {
        ...
        public bool HRSync(object id, object empid, object leaveid, object pertimeid, object frmdate, object todate, object frmtime, object totime, object regdate, object days)
        {
            ...
            //Transfer to HRM
            provider.CommandText = "Insert into tblEmpDayOff (EmployeeID, FromDate, PerTimeID, ToDate, Days, LeaveID, FromTime, ToTime, RegistedDate) values(@EmployeeID, @FromDate, @PerTimeID, @ToDate, @Days, @LeaveID, @FromTime, @ToTime, @RegistedDate)";
        ...
        public bool HRReturn(object id, object empid, object leaveid, object pertimeid, object frmdate, object todate, object frmtime, object totime, object regdate, object days)
        {
            bool value = false;
            khSqlServerProvider provider = new khSqlServerProvider(ConString);
            provider.CommandText = "Update tblWebdata set HRCheckingStatus = 1, HRview = 'r', HRCheckingDate = getdate() "
                                 + " ,ApprovingDate_L1 = NULL ,ApprovingDate_L2 = NULL ,ApprovingDate_L3 = NULL"
                                 + " ,ApprovingReason_L1 = NULL, ApprovingReason_L2 = NULL, ApprovingReason_L3 = NULL"
                                 + " ,ApprovingStatus_L1 = NULL, ApprovingStatus_L2 = NULL, ApprovingStatus_L3 = NULL"
                                 + " ,MailToL1 = NULL, MailToL2 = NULL, MailToL3 = NULL"
                                 + " ,MailToUser = NULL, FinalStatus = 'r' "
                                 + " where ID = @id";
            provider.ParameterCollection = new string[] { "@id" };
            provider.ValueCollection = new object[] { id };
            int i = provider.ExecuteNonQuery();
        ...
        public DataTable getObjectByID(object keyID)
        {
            try
            {
                khSqlServerProvider provider = new khSqlServerProvider(ConString);
                ...
                provider.ParameterCollection = new string[] { "@id" };
                provider.ValueCollection = new object[] { keyID };
                DataTable dt = provider.GetDataTable();
                return dt;
            }
            catch (Exception ex)
