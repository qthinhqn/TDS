...
namespace NPOL
{
    public class tblEmpManagerLevel
    {
        private string ConString = "";
        public tblEmpManagerLevel(string constring)
        {
            ConString = constring;
        }
        ...
        public object getManagerID(object EmployeeID, object level)
        {
            ...
            provider.CommandText = "Select ManagerID_L" + level.ToString() + " from tblEmpManagerLevel where EmployeeID = @EmployeeID";
        ...
        {            
            ...
            khSqlServerProvider provider = new khSqlServerProvider(ConString);
            provider.CommandText = "Select ManagerID_L1, ManagerID_L2, ManagerID_L3 from tblEmpManagerLevel where EmployeeID = @EmpID";
