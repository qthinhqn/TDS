<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AF_ManagerLevelNew.aspx.cs" Inherits="NPOL.AF_ManagerLevelNew" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl>
                            ...
                            <div>
                                ...
                                <asp:SqlDataSource ID="dsDinhCap" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                    SelectCommand="SELECT dbo.tblEmpManagerLevel.EmployeeID, dbo.tblEmpManagerLevel.ManagerID_L1, dbo.tblEmpManagerLevel.ManagerID_L2, dbo.tblEmpManagerLevel.ManagerID_L3, dbo.tblEmployee.LineID, dbo.tblEmployee.SectionID, dbo.tblEmployee.PosID FROM dbo.tblEmpManagerLevel LEFT OUTER JOIN dbo.tblEmployee ON dbo.tblEmpManagerLevel.EmployeeID = dbo.tblEmployee.EmployeeID"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="dsEmp" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsEmp2" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsDep" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsSubDep" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                    SelectCommand="SELECT DISTINCT LineID, LineName from tblEmployee where (LineID is not null) and (LineName <> N'')"></asp:SqlDataSource>
                                <asp:SqlDataSource ID="dsM1" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsM2" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsM3" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                                ...
                                <asp:SqlDataSource ID="dsPos" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>"
                    ...
                    <ContentCollection>
                        <dx:ContentControl>
                            ...
                            <div style="margin-top: 5px">
                                ...
                                <asp:SqlDataSource ID="dsDepartment" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" 
                                ...
                                <asp:SqlDataSource ID="dsSubDepartment" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" 
                                ...
                                <asp:SqlDataSource ID="dsEmpLevel" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" 
                                ...
                                <asp:SqlDataSource ID="dsDinhCapTMP" runat="server" ConnectionString="<%$ ConnectionStrings:PERFETTIConnectionString %>" 
                                    DeleteCommand="DELETE FROM [tblEmpManagerLevel_tmp] WHERE [EmployeeID] = @EmployeeID" 
                                    InsertCommand="INSERT INTO dbo.tblEmpManagerLevel_tmp(EmployeeID, DateChange, SectionID, LineID, PosID, ManagerID_L1, ManagerID_L2, ManagerID_L3) VALUES (@EmployeeID, getdate(), @SectionID, @LineID, @PosID, @ManagerID_L1, @ManagerID_L2, @ManagerID_L3)" 
                                    ...
                                    UpdateCommand="UPDATE [tblEmpManagerLevel_tmp] SET [SectionID] = @SectionID, [LineID] = @LineID, [PosID] = @PosID, [ManagerID_L1] = @ManagerID_L1, [ManagerID_L2] = @ManagerID_L2, [ManagerID_L3] = @ManagerID_L3 WHERE [EmployeeID] = @EmployeeID">
                                    <DeleteParameters>
