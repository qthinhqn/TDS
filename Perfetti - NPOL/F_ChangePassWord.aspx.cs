...
namespace NPOL
{
    public partial class F_ChangePassword : System.Web.UI.Page
    {
        ...
        protected void lbtThayDoi_Click(object sender, EventArgs e)
        {
            ...
            lbThongBao.Text = "";
            Khuong kh = new Khuong(conn.WebConfigurationManager.ConnectionStrings["PERFETTIConnectionString"].ConnectionString);
