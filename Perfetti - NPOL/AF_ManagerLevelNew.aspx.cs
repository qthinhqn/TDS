                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (z > 0)
                        {
                            ...
                            tblWebData web = new tblWebData(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["PERFETTIConnectionString"].ConnectionString);
                            tblEmpManagerLevel emp = new tblEmpManagerLevel(System.Web.Configuration.WebConfigurationManager.ConnectionStrings["PERFETTIConnectionString"].ConnectionString);
