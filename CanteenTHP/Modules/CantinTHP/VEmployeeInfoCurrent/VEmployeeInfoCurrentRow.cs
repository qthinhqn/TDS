...
namespace Canteen.CantinTHP.Entities
{
    ...
    [ConnectionKey("CantinTHP"), Module("CantinTHP"), TableName("[dbo].[v_EmployeeInfoCurrent]")]
    [DisplayName("V Employee Info Current"), InstanceName("V Employee Info Current")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class VEmployeeInfoCurrentRow : Row, IIdRow, INameRow
    {
        ...
        public VEmployeeInfoCurrentRow()
            : base(Fields)
        {
        }
