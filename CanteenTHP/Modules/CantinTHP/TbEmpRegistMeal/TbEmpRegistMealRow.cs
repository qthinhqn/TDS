...
namespace Canteen.CantinTHP.Entities
{
    ...
    [ConnectionKey("CantinTHP"), Module("CantinTHP"), TableName("[dbo].[tbEmpRegistMeal]")]
    [DisplayName("Tb Emp Regist Meal"), InstanceName("Tb Emp Regist Meal")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class TbEmpRegistMealRow : Row, IIdRow, INameRow
    {
