...
namespace Canteen.CantinTHP.Entities
{
    ...
    [ConnectionKey("CantinTHP"), Module("CantinTHP"), TableName("[dbo].[tbEmpPartnerMeal]")]
    [DisplayName("Tb Emp Partner Meal"), InstanceName("Tb Emp Partner Meal")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class TbEmpPartnerMealRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Reason Id"), Column("ReasonID")]
        public Int32? ReasonId
        {
            get { return Fields.ReasonId[this]; }
            set { Fields.ReasonId[this] = value; }
        }

        [DisplayName("Notes"), Size(250)]
        public String Notes
        {
